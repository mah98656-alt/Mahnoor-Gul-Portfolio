...
export default function ContactPage() {
  ...
  const socialLinks = [
    ...
    { label: 'INSTAGRAM', value: '@noormahh23', href: siteConfig.instagram, external: true },
    { label: 'LINKEDIN', value: 'linkedin.com/in/mahnoor-gul', href: siteConfig.linkedin, external: true },
  ]
      ...
      <div className="min-h-screen bg-bg">
        ...
        >
          ...
          <div className="container-site relative z-10">
            ...
            >
              Available for full-time motion design, animation, and multimedia opportunities.
              Also open to freelance and collaborations worldwide. I typically respond within 24–48 hours.
            </motion.p>
          </div>
        </section>
              ...
              {submitted ? (
                ...
                <Reveal delay={0.05}>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <motion.button
                      type="submit"
                      className="btn-lift w-full label bg-accent text-white py-4 rounded-sm hover:bg-accent-hover"
                      whileTap={{ scale: 0.97 }}
                      transition={{ duration: 0.1, ease: [0.34, 1.4, 0.64, 1] }}
                    >
                      SEND MESSAGE →
                    </motion.button>
                    <p className="label text-secondary/30 text-center" style={{ textTransform: 'none' }}>
            ...
            <Reveal>
              <div className="flex flex-wrap items-center gap-6">
                ...
                <div>
                  ...
                  <p className="font-display font-bold text-primary text-lg">Full-Time · Freelance · Remote</p>
                </div>
                <div className="w-px h-8 bg-divider hidden md:block" />
                <div>
