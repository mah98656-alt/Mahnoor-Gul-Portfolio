          ...
          <div>
            ...
            >
              <motion.button
                ...
                className="btn-lift flex items-center gap-3 bg-accent text-white font-mono text-xs tracking-widest px-7 py-4 rounded-sm"
              ...
              <Link
                href="#work"
                className="btn-lift flex items-center gap-3 border border-primary/30 text-primary font-mono text-xs tracking-widest px-7 py-4 rounded-sm hover:border-primary"
              >
                EXPLORE WORK
                <motion.span
                  animate={{ x: [0, 4, 0] }}
