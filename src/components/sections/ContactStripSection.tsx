        ...
        <div className="container-site relative z-10 text-center">
          ...
          <Reveal delay={0.2}>
            <p className="text-secondary max-w-md mx-auto mb-12" style={{ lineHeight: 1.7 }}>
              Available for full-time animation, motion design, and multimedia opportunities.
              Also open to freelance and collaborations worldwide.
            </p>
          </Reveal>
          <Reveal delay={0.25}>
          ...
          <Reveal delay={0.35}>
            <Link
              href="/contact"
              className="btn-lift inline-flex items-center gap-3 border border-accent text-accent font-mono text-xs tracking-widest px-8 py-4 rounded-sm hover:bg-accent hover:text-white"
            >
              GO TO CONTACT PAGE →
            </Link>
          </Reveal>
