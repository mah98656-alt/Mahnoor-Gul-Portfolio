        ...
        <section className="section-padding bg-bg">
          <div className="container-site grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-7">
              ...
              <Reveal delay={0.15}>
                <p className="text-secondary leading-relaxed mb-5">
                  With a background in Computer Arts and hands-on internship experience at Figment Craft
              ...
              <Reveal delay={0.25}>
                ...
                >
                  ...
                  <p className="text-secondary leading-relaxed text-sm">
                    An animation studio, motion design agency, or creative team where I can
                    contribute meaningful motion work, grow as an artist, and be part of a team that
                    takes visual storytelling seriously. Open to onsite, hybrid, and remote roles.
                  </p>
                </div>
              </Reveal>
            </div>
            ...
            <div className="lg:col-span-5">
              <Reveal delay={0.1}>
                <h3
                  className="font-display font-bold text-primary mb-6"
          ...
          <div className="container-site flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Reveal delay={0.1}>
              <div className="flex gap-4">
                <Link
                  href="/experience"
                  className="btn-lift label border border-divider text-secondary hover:text-primary hover:border-secondary px-6 py-3.5 rounded-sm"
                >
                  VIEW EXPERIENCE
                </Link>
                <Link
                  href="/contact"
                  className="btn-lift label bg-accent text-white hover:bg-accent-hover px-6 py-3.5 rounded-sm"
                >
                  GET IN TOUCH
                </Link>
              </div>
